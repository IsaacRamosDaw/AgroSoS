            ...
            <CCard className="shadow-lg border-0 rounded-4">
              <CCardBody className="p-5">
                ...
                <div className="text-center mb-4">
                  ...
                  />
                  <CCardTitle className="h3 mb-0">{userData.username}</CCardTitle>
                ...
                <div className="mb-4">
                  ...
                  <CRow className="mb-2">
                    ...
                    <CCol xs={7}>{new Date(userData.created_at).toLocaleDateString()}</CCol>
                  </CRow>
                  ...
                  <CRow className="mb-2">
                    ...
                    <CCol xs={7}>{new Date(userData.updated_at).toLocaleDateString()}</CCol>
                  </CRow>
